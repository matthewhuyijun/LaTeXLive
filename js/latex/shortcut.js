  ...
  init_shortcut_layer1: function (index) {
    ...
    for (let m = 0; m < len; m++) {
      ...
      if (!img.dataset.lightSrc) {
        ...
        if (img.src.indexOf("/img/shortcut/layer1/") !== -1) {
          img.dataset.darkSrc = img.src.replace("/img/shortcut/layer1/", "/img/shortcut_dark/layer1/");
        } else if (img.src.indexOf("/img/template/layer1/") !== -1) {
          img.dataset.darkSrc = img.src.replace("/img/template/layer1/", "/img/template_dark/layer1/");
        } else {
